...
import { wgstogcj, rnfile } from "../libs"
...
export default function GeolocationService() {
    ...
    const getLocation = async () => {
        ...
        Geolocation.getCurrentPosition(
            (position) => {
                ...
                //position = wgstogcj(position);
                setLocation(position);
                rnfile.writeGps(position)
    ...
    const getLocationUpdates = async () => {
        ...
        watchId.current = Geolocation.watchPosition(
            (position) => {
                console.log("watchPosition old", position);
                //position = wgstogcj(position);
                setLocation(position);
                rnfile.writeGps(position)
                console.log("watchPosition new", position);
    ...
    //const coords = location?.coords ? wgstogcj(location?.coords) : null
